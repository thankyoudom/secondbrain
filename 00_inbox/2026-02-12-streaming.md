...
## Best Free, Watermark-Free Alternatives to DroidCam
...
- **Setup**: Plug your phone into your PC via USB.  
- **Activation**: Pull down your notification shade, tap "Charging this device via USB," and change the mode to Webcam.  
- **Quality**: On Android 15, you can toggle "HQ" (High Quality) mode in the preview window for a crisp 1080p feed.  
...
- **How it works**: Open vdo.ninja on your phone's mobile browser (Chrome) and click "Add your Camera to OBS." It gives you a link.  
- **Integration**: Paste that link into OBS as a Browser Source.  
- **Pro Tip**: To achieve 1080x1920 vertical resolution, add `&aspect=0.5625` to the end of your VDO.Ninja URL.  
