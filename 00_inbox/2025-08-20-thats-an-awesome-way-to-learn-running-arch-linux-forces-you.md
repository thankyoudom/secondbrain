...
**Exercises**
- **Install Docker**
  - `pacman -S docker`, enable it.
- **Run**
  - `docker run hello-world`
  - `docker run -it archlinux bash`
- **Build**
  - Write a simple Python “hello world” Dockerfile.
  - Run PostgreSQL container and connect with `psql`.
- **Exercise**
  - Write a Bash script that spins up a container, runs a job, cleans up.
...
- **Stretch**
  - Provision multiple containers with Ansible.
...
- Read an Arch Wiki article on something you used that day.

### Weekly Projects
- End of each week, pick a “mini-project” (e.g., set up nginx as a reverse proxy, create a Dockerized Flask app, deploy to cloud).
