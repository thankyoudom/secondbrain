...
### ? Colima vs Docker
- **Colima**: Lightweight, open-source, macOS-native alternative to Docker Desktop.
- **Docker**: Full-featured, widely adopted, but resource-intensive on macOS.

### ? Best ROI: Learn Docker CLI + Colima
- You’ll build transferable container skills.
...
- **Bonus**:
  - Add a webhook to auto-deploy on git push, or add a CMS backend in a container.
