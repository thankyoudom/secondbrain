...
### 1. Kdenlive
- Free, open-source non-linear video editor originally for KDE (works on many distros).
...
### - Flowblade
- Linux-native, open source, might appeal if you’re comfortable with a simpler workflow but powerful enough for many tasks (Wikipedia).
...
So if I were advising: pick Kdenlive as your primary editor, maybe keep OpenShot or something lighter as a fallback.
