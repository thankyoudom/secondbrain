...
|-------|-------------|--------------|
| **Main Hook** | Processed vocal, weird synth, foley | Slice samples in Slicex or use Newtone on vocals |
| **Bass** | Sub + distorted reese or crunchy mid | Vital + Waveshaper / Blood Overdrive |
| **Foley / Perc Layers** | Textures, object hits, vinyl, paper | Layer with Edison-recorded foley or free packs |
| **Pad / Atmosphere** | Dusty, lo-fi or reverb-drenched | LABS + reverb tails + granulizer resamples |
...
- **Fruity Slicer** – perfect for choppy stutter fills.
- **Fruity Convolver** – import weird IRs or use reverse reverb.
...
- Practice formant shifting and pitch automation.

**Week 3: Glitch FX & Fills**
- Design 10 glitch fills using Gross Beat, delay throws, or tape stops.
- Use automation clips and slice audio for surprise FX.
...
Want some **free Ivy Lab style sample packs**, project templates, or help setting up an **FL workflow for resampling + glitch FX**?

We can also dive deeper into **bass design**, **drum swing**, or **groove templates** next. You're right at the edge of unlocking this sound.
